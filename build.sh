...
gn gen --args='target_os="android" is_debug=false dcheck_always_on=false is_component_build=false symbol_level=0 enable_nacl=false remove_webcore_debug_symbols=true use_jumbo_build=false' out/Default
